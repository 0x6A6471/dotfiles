...
-- See httpe://wiki.hypr.land/Configuring/Basics/Monitors/
...
-- wlogout
-- hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd(system))
hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd("walker -m menus:system"))

-- screenshot
hl.bind(
	mainMod .. " + SHIFT + S",
	hl.dsp.exec_cmd(
		'grim -g "$(slurp)" -t ppm - | satty --filename - --early-exit --actions-on-enter save-to-clipboard --copy-command wl-copy'
	)
)
...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("asdbctl-osd up 5"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("asdbctl-osd down 5"), { locked = true, repeating = true })
...
hl.window_rule({
	name = "float-waybar-impala",
	match = { class = "waybar-impala" },
	float = true,
	center = true,
	size = { 1300, 900 },
})
...
hl.window_rule({
	name = "float-waybar-bluetui",
	match = { class = "waybar-bluetui" },
	float = true,
	center = true,
	size = { 1300, 900 },
})
...
hl.window_rule({
	name = "float-waybar-wiremix",
	match = { class = "waybar-wiremix" },
	float = true,
	center = true,
	size = { 1300, 900 },
})
